%%%%%%%%%%%%数据处理   求6种模式的概率+5种I帧内PU类型的概率为特征（11维）
Double_folder_PU = 'E:\梁晓云\video forensics\35intra_pred_modes\I_PU\Double200K_400K\';
Single_folder_PU = 'E:\梁晓云\video forensics\35intra_pred_modes\I_PU\Singles400K\';

Double_folder_MODE = 'E:\梁晓云\video forensics\35intra_pred_modes\intra_pre_modes\Double200K_400K\';
...
for iis=3:length(subfolders1_PU)  
      ...
      Double_feature_i_sum_PU=sum(Double_data_PU);
      SUM_PU=sum((sum(Double_data_PU))')
      Double_feature_prob_PU=Double_feature_i_sum_PU/SUM_PU;
      %MODE
      ...
      Double_feature_prob(1,1:5)=Double_feature_prob_PU;
...
for iis=3:length(subfolders2_PU)  
      ...
      Single_feature_i_sum_PU=sum(Single_data_PU);
      SUM_PU=sum((sum(Single_data_PU))')
      Single_feature_prob_PU=Single_feature_i_sum_PU/SUM_PU;
      %MODE
      ...
      Single_feature_prob(1,1:5)=Single_feature_prob_PU;
