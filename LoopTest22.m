%%%%%%%%%%%%数据处理   求所有帧的PU类型的概率为特征（25维）
P_CU_Double_folder = 'J:\梁晓云\video forensics\35intra_pred_modes\CIF\ALLP_CU\Double300K_200K\';
P_CU_Single_folder = 'J:\梁晓云\video forensics\35intra_pred_modes\CIF\ALLP_CU\Single200K\';

I_CU_Double_folder = 'J:\梁晓云\video forensics\35intra_pred_modes\CIF\I_CU\Double300K_200K\';
I_CU_Single_folder = 'J:\梁晓云\video forensics\35intra_pred_modes\CIF\I_CU\Single200K\';
 %%%%%%   Double_featire
...
mm=0;
for iis=3:length(P_CU_subfolders1)  
      if P_CU_subfolders1{iis}==0
           continue
      end
      %%%%%%%%%%%%%%         P_CU
     ...
     CU_Double_feature_i_sum=P_CU_Double_feature_i_sum+I_CU_Double_feature_i_sum;
      ...
      Double_feature_prob=CU_Double_feature_prob;
...
mm=0;
for iis=3:length(P_CU_subfolders2)  
      if P_CU_subfolders2{iis}==0
           continue
      end
      %%%%%%%%%%%%%%%           P_CU
    ...
    CU_Single_feature_i_sum=P_CU_Single_feature_i_sum+I_CU_Single_feature_i_sum;
      ...
      Single_feature_prob=CU_Single_feature_prob;
     mm=mm+1;
