%%%%%%%%%%%%数据处理   求25种首个P帧内PU类型的直方图 4*4  首个P帧（25维）
Double_folder = 'E:\35intra_pred_modes\1080p\P_PUNum\Double50M-70M\';
Single_folder = 'E:\35intra_pred_modes\1080p\P_PUNum\Single70M\';
 %%%%%%   Double_featire
...
for iis=3:length(subfolders1)  
      ...
      %换算为4*4为单位
    Double_data(:,2)=Double_data(:,1)*4;   %8*8
    Double_data(:,3)=Double_data(:,3)*2;   %8*4
    Double_data(:,4)=Double_data(:,4)*2;   %4*8
    Double_data(:,5)=Double_data(:,5)*16;   %16*16
    Double_data(:,6)=Double_data(:,6)*8;   %16*8
    Double_data(:,7)=Double_data(:,7)*8;   %8*16
    Double_data(:,8)=Double_data(:,8)*4;   %16*4
    Double_data(:,9)=Double_data(:,9)*4;   %4*16
    Double_data(:,10)=Double_data(:,10)*12;   %16*12
    Double_data(:,11)=Double_data(:,11)*12;   %12*16
    Double_data(:,12)=Double_data(:,12)*64;   %32*32
    Double_data(:,13)=Double_data(:,13)*32;   %32*16
    Double_data(:,14)=Double_data(:,14)*32;   %16*32
    Double_data(:,15)=Double_data(:,15)*48;   %32*24
    Double_data(:,16)=Double_data(:,16)*48;   %24*32
    Double_data(:,17)=Double_data(:,17)*16;   %32*8
    Double_data(:,18)=Double_data(:,18)*16;   %8*32
    Double_data(:,19)=Double_data(:,19)*256;   %64*64
    Double_data(:,20)=Double_data(:,20)*128;   %64*32
    Double_data(:,21)=Double_data(:,21)*128;   %32*64
    Double_data(:,22)=Double_data(:,22)*192;   %64*48
    Double_data(:,23)=Double_data(:,23)*192;   %48*64
    Double_data(:,24)=Double_data(:,24)*64;   %64*16
    Double_data(:,25)=Double_data(:,25)*64;   %16*64
...
for iis=3:length(subfolders2)  
      ...
      [m,n]=size(Single_data);
           %换算为4*4为单位
    Single_data(:,2)=Single_data(:,1)*4;   %8*8
    Single_data(:,3)=Single_data(:,3)*2;   %8*4
    Single_data(:,4)=Single_data(:,4)*2;   %4*8
    Single_data(:,5)=Single_data(:,5)*16;   %16*16
    Single_data(:,6)=Single_data(:,6)*8;   %16*8
    Single_data(:,7)=Single_data(:,7)*8;   %8*16
    Single_data(:,8)=Single_data(:,8)*4;   %16*4
    Single_data(:,9)=Single_data(:,9)*4;   %4*16
    Single_data(:,10)=Single_data(:,10)*12;   %16*12
    Single_data(:,11)=Single_data(:,11)*12;   %12*16
    Single_data(:,12)=Single_data(:,12)*64;   %32*32
    Single_data(:,13)=Single_data(:,13)*32;   %32*16
    Single_data(:,14)=Single_data(:,14)*32;   %16*32
    Single_data(:,15)=Single_data(:,15)*48;   %32*24
    Single_data(:,16)=Single_data(:,16)*48;   %24*32
    Single_data(:,17)=Single_data(:,17)*16;   %32*8
    Single_data(:,18)=Single_data(:,18)*16;   %8*32
    Single_data(:,19)=Single_data(:,19)*256;   %64*64
    Single_data(:,20)=Single_data(:,20)*128;   %64*32
    Single_data(:,21)=Single_data(:,21)*128;   %32*64
    Single_data(:,22)=Single_data(:,22)*192;   %64*48
    Single_data(:,23)=Single_data(:,23)*192;   %48*64
    Single_data(:,24)=Single_data(:,24)*64;   %64*16
    Single_data(:,25)=Single_data(:,25)*64;   %16*64
...
for x=1:20
   ...
   testNum=randperm(32,5);   %%%%%     27个训练，5个测试   ，共32个
    %分离测试集和数据集  
