%%%%%%%%%%%%数据处理   原始875维
Double_folder = 'E:\梁晓云\video forensics\35intra_pred_modes\Double100K_300K\';
...
for iis=3:length(subfolders1)  
      ...
      nn=1;
      for i=1:m
          Double_feature_i(1,nn:nn+34)=Double_data(i,:);
          nn=nn+35;
      end
     mm=mm+1;
...
for iis=3:length(subfolders2)  
      ...
      nn=1;
      for i=1:m
          Single_feature_i(1,nn:nn+34)=Single_data(i,:);
          nn=nn+35;
      end
     mm=mm+1;
